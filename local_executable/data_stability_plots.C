...
void plot_norm_counts_plots(TH1D* norm_count_plot_1, const char* date_1, TH1D* norm_count_plot_2, const char* date_2, const char* plot_title, const char* output_file_name){
    ...
    // Y Axis
    norm_count_plot_1->GetYaxis()->SetTitle("Norm. Counts");
    norm_count_plot_1->GetYaxis()->SetLabelSize(0.06); //0.05
    norm_count_plot_1->GetYaxis()->SetTitleSize(0.07); //0.06
    norm_count_plot_1->GetYaxis()->SetTitleOffset(0.6); //0.65
    // X Axis
    norm_count_plot_1->GetXaxis()->SetLabelOffset(999);
    norm_count_plot_1->GetXaxis()->SetLabelSize(0);
    norm_count_plot_1->GetXaxis()->SetRangeUser(1e-1,1e6);
    ...
    norm_count_plot_2->GetXaxis()->SetRangeUser(1e-1,1e8);
    norm_count_plot_2->Draw("SAME");

    l[plot_index] = new TLegend(0.75,0.65,0.9,0.8);
    ...
    p[plot_index][1]->SetBottomMargin(0.3);
    ...
    residual_plot[plot_index]->GetXaxis()->SetTitleSize(0.12); //0.10
    residual_plot[plot_index]->GetXaxis()->SetLabelOffset(0.01); //0.01
    residual_plot[plot_index]->GetXaxis()->SetTitleOffset(1.13); //0.85 //decrease to move up
    residual_plot[plot_index]->GetXaxis()->SetLabelSize(0.12); //0.07
    // Y Axis
    residual_plot[plot_index]->GetYaxis()->SetTitle("Frac. Residuals");
    residual_plot[plot_index]->GetYaxis()->SetTitleSize(0.12); //0.10
    residual_plot[plot_index]->GetYaxis()->SetTitleOffset(0.32); //0.38
    residual_plot[plot_index]->GetYaxis()->SetLabelSize(0.12); //0.07
    residual_plot[plot_index]->GetYaxis()->SetNdivisions(5);
    // TGaxis::SetExponentOffset(-0.06, -0.8, "y"); // X and Y offset for Y axis
    residual_plot[plot_index]->GetXaxis()->SetRangeUser(1e-1,1e6);
...
void data_stability_plots(){
    ...
    // plot_norm_counts_plots(norm_counts_empty_sep19_PTBC, "Sep 19", norm_counts_empty_oct01_PTBC, "Oct 01", "Normalized Counts - No Filter - Fission Chamber", "norm_counts_empty_Sep19_Oct01_PTBC");
    // plot_norm_counts_plots(norm_counts_Bi_sep17_PTBC, "Sep 17", norm_counts_Bi_sep23_PTBC, "Sep 23", "Normalized Counts - Bi (1 cm) - Fission Chamber", "norm_counts_bi_Sep17_Sep23_PTBC");
    // plot_norm_counts_plots(norm_counts_Al5_sep25_PTBC, "Sep 25", norm_counts_Al5_oct02_PTBC, "Oct 02", "Normalized Counts - Al (5 cm) - Fission Chamber", "norm_counts_al5_Sep25_Oct02_PTBC");
    // plot_norm_counts_plots(norm_counts_emptyTank_oct12_PTBC, "Oct 12", norm_counts_emptyTank_oct16_PTBC, "Oct 16", "Normalized Counts - Empty CF Tank - Fission Chamber", "norm_counts_emptyTank_Oct12_Oct16_PTBC");
    // plot_norm_counts_plots(norm_counts_ArgonFull_oct18_PTBC, "Oct 18", norm_counts_ArgonFull_oct22_PTBC, "Oct 22", "Normalized Counts - Argon Tank - Fission Chamber", "norm_counts_argonTank_Oct18_Oct22_PTBC");

    // Plotting FIMG Normalized counts plots
    plot_norm_counts_plots(norm_counts_empty_sep19_FIMG, "Sep 19", norm_counts_empty_oct01_FIMG, "Oct 01", "Normalized Counts - No Filter - Micromegas", "norm_counts_empty_Sep19_Oct01_FIMG");
    plot_norm_counts_plots(norm_counts_Bi_sep17_FIMG, "Sep 17", norm_counts_Bi_sep23_FIMG, "Sep 23", "Normalized Counts - Bi (1 cm) - Micromegas", "norm_counts_bi_Sep17_Sep23_FIMG");
    plot_norm_counts_plots(norm_counts_Al5_sep25_FIMG, "Sep 25", norm_counts_Al5_oct02_FIMG, "Oct 02", "Normalized Counts - Al (5 cm) - Micromegas", "norm_counts_al5_Sep25_Oct02_FIMG");
    plot_norm_counts_plots(norm_counts_emptyTank_oct12_FIMG, "Oct 12", norm_counts_emptyTank_oct16_FIMG, "Oct 16", "Normalized Counts - Empty CF Tank - Micromegas", "norm_counts_emptyTank_Oct12_Oct16_FIMG");
    plot_norm_counts_plots(norm_counts_ArgonFull_oct18_FIMG, "Oct 18", norm_counts_ArgonFull_oct22_FIMG, "Oct 22", "Normalized Counts - Argon Tank - Micromegas", "norm_counts_argonTank_Oct18_Oct22_FIMG");
