...
void determine_gamma_flash_cuts(Int_t det_num, TH1D* cut_hist){
    ...
    PTBC_tof_amp_hist_forCuts = (TH2D*)PTBC_tof_amp_hists[det_num-2]->Rebin2D((Int_t) 1000/bins_per_decade_cuts, 50, Form("PTBC_tof_amp_forCuts_det%i", det_num));
...
void cutoffFitter_PTBC() {
    ...
    PTBC_tof_amp_hists[0] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det2");
    PTBC_tof_amp_hists[1] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det3");
    PTBC_tof_amp_hists[2] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det4");
    PTBC_tof_amp_hists[3] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det5");
    PTBC_tof_amp_hists[4] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det6");
    PTBC_tof_amp_hists[5] = retriveHistograms("../rootFiles/cutoffAnalysis_PTBC_al5.root", "PTBC_tof_amp_fOut_det7");
